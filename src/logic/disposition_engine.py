...
from src.logic.cost_basis_strategies import CostBasisStrategy, FIFOBasisStrategy, AverageCostBasisStrategy # NEW: Import strategies
...
class DispositionEngine:
    ...
    """
    def __init__(self, cost_basis_strategy: CostBasisStrategy): # MODIFIED: Accepts a CostBasisStrategy
